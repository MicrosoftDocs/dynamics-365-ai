...
- **Aggregate-level insights** (#1): Tiles with unique insights about your total customer base. Can include predictive key performance indicators (KPIs) such as average likelihood of a customer churn.
