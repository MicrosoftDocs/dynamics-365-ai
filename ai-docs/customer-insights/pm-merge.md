...
<!--It looks like the following section duplicates the first paragraphs of this topic. I'm commenting them out.-->

<!--
1. Choosing all the attributes that should be merg# Merge
...
<!--Looks like the following paragraphs duplicate previous paragraphs. I'm commenting them out.-->

<!--## Next step

Congratulations! You have completed both the *Data Manager* and *Configure Data* phases. Now you are ready to:

- Either complete more data configurations (*Activities*, *Relationships*, and *Enrich Profiles*), while  optional, theyed within your unified customer profile entity (the end result of the configuration process). Notice that some attributes were already auto-merged by the system.
