...
For more information about getting a connection between [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)] and [!INCLUDE[pn_azure_event_hubs](../includes/pn-azure-event-hubs.md)] up and running, see [Stream data from Market Insights to Microsoft Azure Event Hubs](stream-data-to-event-hubs.md).  

<a name="overview"></a>   
## Overview  
When [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)] streams events to [!INCLUDE[pn_azure_event_hubs](../includes/pn-azure-event-hubs.md)], a JSON payload is generated. A single social post in [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)] is a single event in the event hub. The JSON payload contains information about a single social post that matches the defined filters and action on the automation rules that generated the payload. Additional properties that you define in your automation rules are part of the [metadata object](#metadataProperties). The main content is part of the [post object](#documentProperties).  
...
|                        JSON element                        |                                                                     Description                                                                      |
|------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------|
|                  [post.id](#document.id)                   |                The unique post ID in the [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)] solution database.                |
...
|     [post.acquisitionDate](#document.acquisitionDate)      |       Timestamp when the post was acquired in [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)] (in ISO 8601 format).        |
|    [post.modificationDate](#document.modificationDate)     |     Timestamp when  the post was last updated in [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)] (in ISO 8601 format).     |
...
This is a sample post payload for a [!INCLUDE[tn_twitter](../includes/tn-twitter.md)] reply acquired through [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)]. We've made up some values to anonymize the sample.  
...
This is a sample post payload for a [!INCLUDE[tn_twitter](../includes/tn-twitter.md)] retweet acquired through [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)]. We've made up some values to anonymize the sample.  
...
This is a sample post payload for a [!INCLUDE[tn_facebook](../includes/tn-facebook.md)] reply acquired through [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)]. We've made up some values to anonymize the sample.  
...
##### Sample video post  
This is a sample post payload for a video post acquired through [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)]. We've made up some values to anonymize the sample.  
...
##### Sample blog post  
This is a sample post payload for a blog post acquired through [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)]. We've made up some values to anonymize the sample.  
...
##### Sample forum post  
This is a sample post payload for a forum post acquired through [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)]. We've made up some values to anonymize the sample.  
...
### post.id  
The unique post ID in the [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)] solution database.  
...
Timestamp when the post was acquired in [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)] (in ISO 8601 format).  
...
Timestamp when  the post was last updated in [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)] (in ISO 8601 format).  
...
In the [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)] user interface, this is referred to as an "author". More information: [Find out what people are talking about](analytics-conversations.md), [See author details](author-details.md)  
...
|                           JSON element                            |                                                          Description                                                          |
|-------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------|
|             [post.profile.uri](#document.profile.uri)             | Unique URI of the profile in the [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)] solution database. |
...
|            [post.profile.name](#document.profile.name)            |     Name for the profile in the [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)] user interface.     |
...
#### post.profile.uri  
Unique URI of the profile in the [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)] solution database.
...
#### post.profile.name  
Representation in [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)] for the name for the profile.  
...
### post.tags  
Array of JSON objects representing tags on a post that were added through [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)].  
...
- system: [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)] added the tag to the post.  

- user: A user manually  added the tag to the post.  

- confirmed: A user confirmed a tag that was added by [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)].  
...
#### post.origin.id  
ID of the internal representation in [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)] for the origin of a post.  
...
Name of the search topic as defined in [!INCLUDE[Market Insights](../includes/pn-market-insights-short.md)]. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Set up searches to listen to social media conversations](set-up-searches.md)  
