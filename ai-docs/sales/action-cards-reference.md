...
| <a name="RelationshipAnalytics"></a>**#Relationship analytics** <br/> ![Relationship analytics](media/ActionCard_RelationshipAnalytics.png "Insight card for relationship analytics") | **Description**: <br>This card is provided as an alert when you have an opportunity that is similar to deals that are won recently.<br>**Feature**:<br>Indicates that the current opportunity is similar to the opportunities that were won previously. By looking at the similar won deals, you can learn what's working better for a deal and learn about the best engagement practices. <br>**Actions**: <br>See best practices<br>**Prerequisite**: <br> Enable premium auto capture to use this card. To learn more, see [How to enable and configure premium auto capture](configure-auto-capture.md#how-to-enable-and-configure-premium-auto-capture). |
