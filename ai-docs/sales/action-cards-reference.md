...
Base cards relate to the core features of Dynamics 365 Sales such as contacts and opportunities. These are the only insight cards that are available for Dynamics 365 for Customer Engagement (on-premises). The following are basic features of the cards:  
