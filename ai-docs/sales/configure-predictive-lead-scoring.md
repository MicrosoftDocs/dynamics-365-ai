...
>- From 2020 release wave 2 for Dynamics 365, we are writing the lead scoring related data to **msdyn_predictivescore** entity. This entity is common for both lead and opportunity scoring. More information: [Entity reference](entity-reference.md).
