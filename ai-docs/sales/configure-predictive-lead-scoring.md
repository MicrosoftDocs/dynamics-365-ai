...
When the predictive lead scoring configuration section is opened for the first time in your organization and no models have been trained on installation<!--Is this what "on install" means?-->, you must add the model.
