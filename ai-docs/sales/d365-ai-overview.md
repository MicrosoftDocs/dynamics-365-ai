...
<!--from editor: Don't forget to add the URL to the following link.-->
   ...
   Select the **View full report** icon ![Forecast quick view](media/d365-ai-sales-forecastviewfullreporticon.png "Forecast quick view") on the Leaderboard pane to go to the **Leaderboard** tab. More information: View sales rep performance <link to the section>
...
<!--from editor: Remember to add URL to the link below.-->
   ...
   Select the **View full report** icon ![Forecast quick view](media/d365-ai-sales-forecastviewfullreporticon.png "Forecast quick view") on the Pipeline pane to go to the Pipeline tab. More information: View potential opportunities <link to the section>
