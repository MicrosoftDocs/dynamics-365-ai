...
Install [!INCLUDE[pn_dynamics_ai_sales](../includes/pn-dynamics-ai-sales.md)] and enable the Relationship analytics feature from  **Settings** > **AI setup**.​
...
Install [!INCLUDE[pn_dynamics_ai_sales](../includes/pn-dynamics-ai-sales.md)] and use standard lead entity or standard opportunity entity.​
...
Install [!INCLUDE[pn_dynamics_ai_sales](../includes/pn-dynamics-ai-sales.md)] and enable the Notes analysis feature from **Settings** > **AI setup**.​
...
Install [!INCLUDE[pn_dynamics_ai_sales](../includes/pn-dynamics-ai-sales.md)] and enable the Talking points feature from **Settings** > **AI setup**.​
...
Install [!INCLUDE[pn_dynamics_ai_sales](../includes/pn-dynamics-ai-sales.md)], opt in to Connection insights from the Office 365 admin, and enable the Who knows whom feature from **Settings** > **AI setup**.​
