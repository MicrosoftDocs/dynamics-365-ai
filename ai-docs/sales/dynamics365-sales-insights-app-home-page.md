...
For specific privacy information about [!INCLUDE[pn_dynamics_sales_insights](../includes/pn-dynamics-sales-insights.md)] capabilities for sales managers, see the [Dynamics 365 Sales Insights application privacy notices](privacy-notice-manager.md).
