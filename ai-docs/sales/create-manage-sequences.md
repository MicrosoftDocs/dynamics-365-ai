...
- [Clone a sequence](#clone-a-sequence)
...
2. At the bottom of the site map, select **Change area** > **Sales Insights settings**.   
3. Under **Acceleration**, select **Sequence (preview)**.   
4. Go to the **Inactive** tab and a list of inactive sequences are displayed.   
5. Hover over a sequence and select **More options** > **Create a copy**.   
    > [!div class="mx-imgBorder"]
...
7. Select one of the button:   
    - **Edit sequence**: Select this button to open the sequence editor and add steps as necessary. To add steps, see steps 7 and 8 from [Create and activate a sequence](#create-and-activate-a-sequence).
