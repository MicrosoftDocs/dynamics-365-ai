...
Notes analysis provides you with suggestions for actions based on customer-related activities. When you create an activity, such as appointment, phone call, task, note, post, or custom activities, the notes analysis feature anlalyzes the descriptions provided in these activities and gives you intelligent suggestions. With these suggestions, you can taking actions, such as creating a meeting request and adding a contact.
