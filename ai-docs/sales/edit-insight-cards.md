...
> [!NOTE]
> The security roles you see in the cards are defined in the Microsoft Dataverse platform. To learn more on security roles, see [Security roles and privileges](/dynamics365/customer-engagement/admin/security-roles-privileges).
