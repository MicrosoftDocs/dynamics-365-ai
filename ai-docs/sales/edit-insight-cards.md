...
| 3 | Snooze or dismiss | Displays in percentage value the users has performed snooze and dismiss actions on the card. |
| 4 | No action | Displays in percentage value the users didn't performed actions on the card. |
