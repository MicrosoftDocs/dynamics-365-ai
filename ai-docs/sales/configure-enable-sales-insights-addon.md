...
## GDPR
To know about [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)] AI for Sales related **General Data Protection Regulation (GDPR)**, see [Embedded Intelligence and GDPR](embedded-intelligence-gdpr.md).<br>

## Prerequisites
Review the following requirements before you emable and configure [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)] AI for Sales feature:
...
[!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)] AI for Sales features are not available by default. You must enable these features by selecting an organization.
Follow these steps:
...
3. Select **Create Model**.<br>
   ...
   Creating a model takes few minutes and you can see progress on the screen.
...
6. If you want to configure the lead score range, enter minimum value of the range in the Lead Scoring Range.
...
2. On the **Overview** tab, select **Configuration** from **Predictive opportunity scoring** section.<br>
   ![Predictive opportunity scoring configuration](media/predictive-opportunity-scoring-configuration.png "Predictive opportunity scoring configuration") <!--image should be added--><br>
   > [!NOTE]   
   > You can also select **Predictive opportunity scoring** tab.

   The configuration page opens. 
3. Select **Create Model**.<br>
   ![Create model in Predictive opportunity scoring](media/predictive-opportunity-scoring-create-model.png "Create model in Predictive opportunity scoring")<!--image should be added--><br>
   Creating a model takes few minutes and you can see progress on the screen.
4. Verify that the **Prediction Accuracy** score from **Model Outcome** matches your organizational requirements and select **Apply Model**.<br>
   ![Predictive opportunity scoring accuracy score](media/predictive-opportunity-scoring-score-accuracy.png "Predictive opportunity scoring accuracy score")<!--image should be added--><br>
...
5. (Optional) If you are not satisfied with the **Prediction Accuracy** score, select **Retrain Model** and apply.<br>
   > [!NOTE]
   > We recommend you to train the model once the data is refreshed in our organization for better prediction accuracy scoring.
6. If you want to configure the opportunity score range, enter minimum value of the range in the Opportunity Scoring Range.
   ...
   ![Predictive opportunity scoring change maximun score for grade](media/predictive-opportunity-scoring-change-max-score.png "Predictive opportunity scoring change maximun score for grade")<!--image should be added-->
7. Save and apply the model. <br>
...
These features help users in your organization to quickly establish communications with customers. 
...
3. To configure Who knows whom and Icebreakers, perform the following steps:
   -  **Who knows whom**<br>
        a. On the **Who knows whom** section, select **Turn on Who Knows Whom for your organization**.
        <!--Image should be included-->
        b. Optionally, you can select the **Email template** according to your organizational requirements. By default, an out-of-the-box email template will be selected.<br>
        c. Select **Save**. <br>
        The Who Knows Whom is configured and ready to use in your organization. 
    -  **Icebreakers**<br>
        a. On the **Icebreakers** section, select **Turn on Icebreakers for your organization**.
