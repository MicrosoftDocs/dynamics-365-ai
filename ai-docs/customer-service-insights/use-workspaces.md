...
> [!Note]
> If you have a Customer Service Enterprise license, you will no longer be able to create new workspaces. Instead, consider migrating to the [embedded experience](/dynamics365/customer-service/introduction-customer-service-analytics) within the core Dynamics 365 Customer Service applications. 
