...
3. Under **Phrases to ignore (Preview)**, specify the phrases you want omitted by using the following conditions:
...
>- Phrases can use up to 200 characters. 
 
>- You can have up to 100 phrases.
...
4. Customer Service Insights gives you the option of refreshing your workspace. The settings take effect when you refresh the workspace. Select **Refresh** to refresh the workspace.
