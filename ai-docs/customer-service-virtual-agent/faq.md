...
- Make sure to [create your Flows in Solutions](https://docs.microsoft.com/flow/overview-solution-flows), as the Bot cannot see the Flows created in My Flows tab. 
